...
console.log( 'The value fo fullName is:' , fullName );
...
if ('luckyNumber === 2' && 'adventurous is true') {
    console.log( 'Roll the dice!!' );
}
...
if ( 'pets' > 'friendsPets' ) {
    console.log( 'I am a' , mostPets );
}
if ( 'pets' < 'friendsPets' ) {
    console.log( 'my friend is a' , mostPets );
}
if ( 'pets' == 'friendsPets' ) {
